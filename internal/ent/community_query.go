...
func (cq *CommunityQuery) QuerySocials() *SocialQuery {
...
func (cq *CommunityQuery) QueryCompanies() *CompanyQuery {
...
func (cq *CommunityQuery) QueryAreas() *AreaQuery {
...
func (cq *CommunityQuery) WithSocials(opts ...func(*SocialQuery)) *CommunityQuery {
	query := (&SocialClient{config: cq.config}).Query()
...
func (cq *CommunityQuery) WithCompanies(opts ...func(*CompanyQuery)) *CommunityQuery {
	query := (&CompanyClient{config: cq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (cq *CommunityQuery) WithAreas(opts ...func(*AreaQuery)) *CommunityQuery {
	query := (&AreaClient{config: cq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (cq *CommunityQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Community, error) {
	...
	if query := cq.withSocials; query != nil {
		if err := cq.loadSocials(ctx, query, nodes,
			func(n *Community) { n.Edges.Socials = []*Social{} },
			func(n *Community, e *Social) { n.Edges.Socials = append(n.Edges.Socials, e) }); err != nil {
			return nil, err
		}
	}
	if query := cq.withCompanies; query != nil {
		if err := cq.loadCompanies(ctx, query, nodes,
			func(n *Community) { n.Edges.Companies = []*Company{} },
			func(n *Community, e *Company) { n.Edges.Companies = append(n.Edges.Companies, e) }); err != nil {
			return nil, err
		}
	}
	if query := cq.withAreas; query != nil {
		if err := cq.loadAreas(ctx, query, nodes,
			func(n *Community) { n.Edges.Areas = []*Area{} },
			func(n *Community, e *Area) { n.Edges.Areas = append(n.Edges.Areas, e) }); err != nil {
			return nil, err
		}
	}
...
func (cq *CommunityQuery) loadSocials(ctx context.Context, query *SocialQuery, nodes []*Community, init func(*Community), assign func(*Community, *Social)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(community.SocialsTable)
		s.Join(joinT).On(s.C(social.FieldID), joinT.C(community.SocialsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(community.SocialsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(community.SocialsPrimaryKey[1]))
...
func (cq *CommunityQuery) loadCompanies(ctx context.Context, query *CompanyQuery, nodes []*Community, init func(*Community), assign func(*Community, *Company)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*Community)
	nids := make(map[int]map[*Community]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(community.CompaniesTable)
		s.Join(joinT).On(s.C(company.FieldID), joinT.C(community.CompaniesPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(community.CompaniesPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(community.CompaniesPrimaryKey[1]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
...
func (cq *CommunityQuery) loadAreas(ctx context.Context, query *AreaQuery, nodes []*Community, init func(*Community), assign func(*Community, *Area)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*Community)
	nids := make(map[int]map[*Community]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(community.AreasTable)
		s.Join(joinT).On(s.C(area.FieldID), joinT.C(community.AreasPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(community.AreasPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(community.AreasPrimaryKey[1]))
		s.AppendSelect(columns...)
		s.SetDistinct(false)
	})
	if err := query.prepareQuery(ctx); err != nil {
