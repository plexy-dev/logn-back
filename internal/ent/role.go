...
// was not loaded in eager-loading.
func (e RoleEdges) CompaniesOrErr() ([]*Company, error) {
	if e.loadedTypes[1] {
...
// QueryCompanies queries the "companies" edge of the Role entity.
func (r *Role) QueryCompanies() *CompanyQuery {
	return NewRoleClient(r.config).QueryCompanies(r)
}
