...
func (e LocationEdges) VacanciesOrErr() ([]*Vacancy, error) {
	if e.loadedTypes[0] {
...
// QueryVacancies queries the "vacancies" edge of the Location entity.
func (l *Location) QueryVacancies() *VacancyQuery {
	return NewLocationClient(l.config).QueryVacancies(l)
}
