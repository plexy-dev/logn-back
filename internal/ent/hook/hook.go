...
// The TechnologyLevelFunc type is an adapter to allow the use of ordinary
// function as TechnologyLevel mutator.
type TechnologyLevelFunc func(context.Context, *ent.TechnologyLevelMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TechnologyLevelFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TechnologyLevelMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TechnologyLevelMutation", m)
}

// The VacancyFunc type is an adapter to allow the use of ordinary
// function as Vacancy mutator.
type VacancyFunc func(context.Context, *ent.VacancyMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VacancyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VacancyMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VacancyMutation", m)
}
